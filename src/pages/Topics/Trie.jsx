...
function Trie() {
    // Filter the topics as per the position (12 in this case)
    const filteredData = Data.filter((topic) => topic.position === 12);

    // State to keep track of "Done" status for questions
    ...
    return (
        <React.Fragment>
            <Navbar />
            <div className="abtusheading">{filteredData[0]?.topic}</div>
