...
function SearchSort() {
    // Filter the topics as per the position (3 in this case)
    const filteredData = Data.filter((topic) => topic.position === 3);
    ...
    return (
        <React.Fragment>
            <Navbar />
            <div className="abtusheading">{topic ? topic.topic : 'Search Sort'}</div> {/* Default text if no data */}
