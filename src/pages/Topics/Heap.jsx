...
function Heap() {
    // Filter the topics as per the position (10 in this case)
    const filteredData = Data.filter((topic) => topic.position === 10);
    ...
    return (
        <React.Fragment>
            <Navbar />
            <div className="abtusheading">{topic.topic || 'Heap'}</div> {/* Safely access topic */}
